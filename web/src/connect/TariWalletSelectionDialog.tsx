...
const WALLET_CONNECT_PROJECT_ID = import.meta.env.VITE_WALLET_CONNECT_PROJECT_ID || "78f3485d08b9640a087cbcea000e1f8b";
const WALLET_DAEMON_ENABLED = import.meta.env.VITE_WALLET_DAEMON_ENABLED || true;// always true
...
export function TariWalletSelectionDialog(props: WalletSelectionProps) {
    ...
    const onWalletDaemonClick = async () => {
        const params: WalletDaemonFetchParameters = {
            ...
            serverUrl: "http://127.0.0.1:12015/json_rpc",
        };
